...
defineStep(
  "container logs has {string}",
  { timeout: DockerHelper.waitTimeout },
  function (substring, callback) {
...
defineStep(
  "container health status is changed",
  { timeout: DockerHelper.waitTimeout },
  function (callback) {
    assert.ok(containerRunning, "Container is not running");
...
defineStep(
  "container health status is {string}",
  { timeout: DockerHelper.execTimeout },
